...
export const monthlyReportResponseSchema = z.object({
  ...
  cashFlowSummary: z.string().min(1).optional(),
...
export const monthlyReportCashFlowMetricsSchema = z.object({
...
export type MonthlyReportCashFlowMetrics = z.infer<
  typeof monthlyReportCashFlowMetricsSchema
>;
