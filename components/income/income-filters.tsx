...
import type { MonthOption } from "@/components/expenses/expense-filters";
...
export function IncomeFilters({ categories, months }: IncomeFiltersProps) {
    ...
    >
      <div className="flex items-end gap-2">
        ...
        <button
          ...
          aria-controls="income-more-filters"
          className={[
      ...
      {moreOpen ? (
        <div id="income-more-filters" className="mt-3 space-y-3 border-t pt-3">
